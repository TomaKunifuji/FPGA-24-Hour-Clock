...
HD_PWD='C:/Local_Fuchu/Local_st202402/FPGA/COUNT24_SEL_4/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log COUNT24.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source COUNT24.tcl
