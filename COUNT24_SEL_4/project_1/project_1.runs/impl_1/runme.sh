...
HD_PWD='C:/Local_Fuchu/Local_st202402/FPGA/COUNT24_SEL_4/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log COUNT24.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source COUNT24.tcl -notrace
